...
class TestAuditPage(base.Test):
  ...
  @pytest.mark.parametrize("assessments_count,button_name,exp_page_number",
  ...
  def test_switch_page_forward_buttons_work_correct_on_assessments_widget(
      self, selenium, rest_create_audit, rest_create_control,
          assessments_count, button_name, exp_page_number):
    ...
    assert exp_page_number == actual_page_number
